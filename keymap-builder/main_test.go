...
func TestSerialRowCol(t *testing.T) {
	assert.Equal(t, l(1, 1), RCFrom(0))
	assert.Equal(t, l(1, 2), RCFrom(1))
	assert.Equal(t, l(1, 3), RCFrom(2))
	assert.Equal(t, l(1, 4), RCFrom(3))
	assert.Equal(t, l(1, 5), RCFrom(4))
	assert.Equal(t, l(1, 6), RCFrom(5))
	assert.Equal(t, r(1, 1), RCFrom(6))
	assert.Equal(t, r(1, 2), RCFrom(7))
	assert.Equal(t, r(1, 3), RCFrom(8))
	assert.Equal(t, r(1, 4), RCFrom(9))
	assert.Equal(t, r(1, 5), RCFrom(10))
	assert.Equal(t, r(1, 6), RCFrom(11))
	assert.Equal(t, l(2, 1), RCFrom(12))
	assert.Equal(t, l(2, 2), RCFrom(13))
	assert.Equal(t, l(2, 3), RCFrom(14))
	assert.Equal(t, l(2, 4), RCFrom(15))
	assert.Equal(t, l(2, 5), RCFrom(16))
	assert.Equal(t, l(2, 6), RCFrom(17))
	assert.Equal(t, r(2, 1), RCFrom(18))
	assert.Equal(t, r(2, 2), RCFrom(19))
	assert.Equal(t, r(2, 3), RCFrom(20))
	assert.Equal(t, r(2, 4), RCFrom(21))
	assert.Equal(t, r(2, 5), RCFrom(22))
	assert.Equal(t, r(2, 6), RCFrom(23))
	assert.Equal(t, l(3, 1), RCFrom(24))
	assert.Equal(t, l(3, 2), RCFrom(25))
	assert.Equal(t, l(3, 3), RCFrom(26))
	assert.Equal(t, l(3, 4), RCFrom(27))
	assert.Equal(t, l(3, 5), RCFrom(28))
	assert.Equal(t, l(3, 6), RCFrom(29))
	assert.Equal(t, r(3, 1), RCFrom(30))
	assert.Equal(t, r(3, 2), RCFrom(31))
	assert.Equal(t, r(3, 3), RCFrom(32))
	assert.Equal(t, r(3, 4), RCFrom(33))
	assert.Equal(t, r(3, 5), RCFrom(34))
	assert.Equal(t, r(3, 6), RCFrom(35))
	assert.Equal(t, l(4, 1), RCFrom(36))
	assert.Equal(t, l(4, 2), RCFrom(37))
	assert.Equal(t, l(4, 3), RCFrom(38))
	assert.Equal(t, r(4, 1), RCFrom(39))
	assert.Equal(t, r(4, 2), RCFrom(40))
	assert.Equal(t, r(4, 3), RCFrom(41))
}
